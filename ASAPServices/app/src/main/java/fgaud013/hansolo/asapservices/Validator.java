...
public class Validator {
    ...
    public boolean isUsernameValid(String username){
        if(username.isEmpty() || username.toLowerCase().equals("username"))
            return false;
        return true;
    }
    ...
    public boolean isPasswordValid(String password){
        if(password.isEmpty() || password.toLowerCase().equals("password") )
            return false;
        return true;
    }
    ...
    public boolean isFirstnameValid(String firstname){
        if(firstname.isEmpty() || firstname.toLowerCase().equals("first name"))
            return false;
        return true;
    }
    ...
    public boolean isLastnameValid(String lastname){
        if(lastname.isEmpty() || lastname.toLowerCase().equals("last name"))
            return false;
        return true;
    }
