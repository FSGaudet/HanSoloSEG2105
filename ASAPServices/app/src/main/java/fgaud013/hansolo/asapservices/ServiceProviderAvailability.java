...
public class ServiceProviderAvailability extends AppCompatActivity {
    ...
    private void dialogAdd(){
        ...
        builder.setMessage("You sure you want to add:\n" +
                fullTime +
    ...
    private void loadSpinnerHours(){
        ...
        try {
            ...
            spinnerET.setSelection(48);
            spinnerST.setSelection(32);
        }
        catch(Exception ex){
            Toast.makeText(this,ex.getMessage(),Toast.LENGTH_LONG).show();
        }
    ...
    private void addAvailability(){
        try {
            ...
            if (valid) {
                ...
                Toast.makeText(this, "There is overlapping.", Toast.LENGTH_LONG).show();
        }
        catch(Exception ex){
